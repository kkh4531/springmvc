...
public class RequestBodyJsonController {
    ...
    public String requestBodyJsonV4(HttpEntity<HelloData> helloDataHttpEntity) throws IOException { // HttpEntity<HelloData>로도 받을 수 있다.
    ...
    * */
    ...
    public HelloData requestBodyJsonV5(@RequestBody HelloData helloData) throws IOException { // HttpEntity<HelloData>로도 받을 수 있다.
        log.info("username={}, age={}", helloData.getUsername(), helloData.getAge());
        return helloData; // 꼭 응답 바디에 String 말고도 객체를 넣으면 바디에 json으로 나간다.
    }
}
